        ...
        <div style={{ padding: 32, background: '#0a0a0a', overflowY: 'auto' }}>
          {page === 'dashboard' && (
            topics.length === 0 ? (
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '80px 20px', textAlign: 'center' }}>
                ...
                <div style={{ fontSize: 13, color: '#555', lineHeight: 1.6, maxWidth: 360 }}>Add a commodity or topic in the sidebar. Choose <strong style={{ color: '#777' }}>Supply chain</strong> for supplier comparisons and pricing, or <strong style={{ color: '#777' }}>Market intel</strong> for intelligence briefings with live price charts.</div>
              </div>
            ) : (
              <>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: 12, color: '#444' }}>
                            {t.chartData ? `${t.chartData.symbol} · $${t.chartData.currentPrice}` : t.report ? 'Updated ' + t.updated : 'No briefing yet'}
                          </div>
                        </div>
                      </div>
          ...
          {page === 'research' && topic && (
            <>
              ...
              {/* Chart */}
              {topic.chartData && (
                <div style={{ background: '#111', border: '0.5px solid #1e1e1e', borderRadius: 10, padding: 24, marginBottom: 16 }}>
                ...
                {loading ? (
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '48px 0', textAlign: 'center' }}>
                    ...
                    <div style={{ fontSize: 13, color: '#555', marginBottom: 22 }}>
                      {topic.mode === 'supplier' ? 'Claude will search for current prices, suppliers, and supply chain risks' : 'Claude will search the web and return a briefing with a live price chart'}
                    </div>
      ...
      chartRef.current = new Chart(canvasRef.current, {
        ...
        data: {
          ...
          datasets: [{
            ...
            tension: 0.3,
            fill: true,
            backgroundColor: isUp ? 'rgba(29,158,117,0.08)' : 'rgba(226,75,74,0.08)',
          }]
        },
        options: {
          responsive: true,
          ...
          scales: {
            x: {
              grid: { color: '#1a1a1a' },
              ticks: { color: '#555', font: { size: 11 }, maxTicksLimit: 6 },
            },
            y: {
              grid: { color: '#1a1a1a' },
