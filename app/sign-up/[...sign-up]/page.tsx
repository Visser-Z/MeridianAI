...
export default function SignInPage() {
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0a", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "24px" }}>
      ...
      <SignIn appearance={{ variables: { colorBackground: "#111111", colorText: "#ffffff", colorPrimary: "#D4537E", colorInputBackground: "#1a1a1a", colorInputText: "#ffffff" } }} forceRedirectUrl="/dashboard" />
    </div>
  );
}