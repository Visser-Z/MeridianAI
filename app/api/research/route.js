...
4. Current pricing — use the right unit (per unit, per kg, per ton, per box, per roll, MOQ pricing)
...
<p><strong>Market overview:</strong> current state of the ${topic} market with latest pricing in the correct unit (per kg, per unit, per ton, per box etc.)</p>
 
<p><strong>Location analysis for ${userLocation}:</strong> assess whether local/regional sourcing is cheaper than importing after adding shipping, import duties, VAT, and taxes. Be specific about cost differences.</p>
 
<p><strong>Supplier comparison:</strong></p>
<table>
<tr><th>Company Name</th><th>Type</th><th>Est. Price Range</th><th>MOQ</th><th>Location</th><th>Lead Time</th><th>Reliability (out of 10)</th><th>Key Notes</th></tr>
...
<p><strong>Total landed cost estimate:</strong> break down the real cost of importing from top global supplier vs buying locally in ${userLocation} including shipping, duties, VAT, and taxes</p>
